# coding:utf-8
"""为人脸检测（face detection）部分准备训练集。
根据wider face的每张图片，从里面扣取一些正例和负例。
iou>0.65为正例， 标记1；0.4~0.65之前为部分脸，标记-1；小于0.3为负例，标记0
"""
import os
import cv2
import numpy as np
...
anno_file = "wider_face_train.txt"  # 训练标注
im_dir = "../../DATA/WIDER_train/images"  # 训练图片
